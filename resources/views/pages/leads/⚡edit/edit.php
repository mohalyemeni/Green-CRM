...
new #[Title('تعديل العميل المحتمل')] class extends Component
{
    ...
    {
        $this->form->update();
        $this->dispatch('notify', type: 'success', message: 'تم تحديث بيانات العميل المحتمل بنجاح!');
        return redirect()->route('admin.leads.show', $this->lead->id);
    }
    ...
    {
        return view('pages.leads.⚡edit.edit');
    }
};
