    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">إضافة عميل محتمل جديد</h4>
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @error('form.last_name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="hstack gap-2 justify-content-end">
                            <a href="{{ route('admin.leads.index') }}" class="btn btn-ghost-danger">
                                <i class="ri-close-line align-bottom me-1"></i> إلغاء
                            </a>
                            <button type="submit" class="btn btn-success" wire:loading.attr="disabled">
                                <span wire:loading.remove wire:target="save">
                                    <i class="ri-save-3-line align-bottom me-1"></i> حفظ العميل المحتمل
                                </span>
