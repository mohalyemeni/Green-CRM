...
new #[Title('إنشاء عرض سعر جديد')] class extends Component
{
    ...
    {
        // افترض أن هناك status = 1 للخدمات المفعلة
    ...
    {
        $this->form->save();
        session()->flash('notify', ['type' => 'success', 'message' => 'تم حفظ عرض السعر بنجاح.']);
