<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel" wire:ignore.self
    ...
    <div class="offcanvas-header bg-light">
        <h5 class="offcanvas-title" id="offcanvasExampleLabel">تصفية الأنشطة التجارية</h5>
            ...
            <div class="mb-4" wire:ignore x-data="{
                ...
                init() {
                    this.choice = new Choices(this.$refs.select, {
                        ...
                        shouldSort: false,
                        placeholderValue: 'اختر العملات بالبحث...',
                        itemSelectText: ''
                    });
                    ...
                    this.$refs.select.addEventListener('change', (e) => {
                        ...
                        $wire.set('selectedCurrencies', selectedValues, false);
                    });
                }
            }">
                <label for="currency-select" class="form-label text-muted text-uppercase fw-semibold mb-3">العملة الأساسية</label>
                <select x-ref="select" class="form-control" id="currency-select" multiple>
                    <option value="">اختر العملات...</option>
